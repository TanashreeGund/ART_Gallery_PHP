            ...
            <div class="contact-list-grid">
               <form action="#" method="post">
                  <div class=" agile-wls-contact-mid">
                     ...
                     <div class="form-group contact-forms">
                     <label >Address:</label>
                       <textarea class="form-control" type="text" placeholder="Address" required="true" rows="2"></textarea>
                     </div>
                     <div class="form-group contact-forms">
                       <label >Payment Method:</label>
                       <table><tr>
                       <td><input class="form-control" type="radio" name="COD" ></td><td>COD</input></td></tr>
                       <tr>
                       <td><input class="form-control" type="radio" name="COD" ></td><td>UPI</input></td></tr>
                       </table>
                     </div>
